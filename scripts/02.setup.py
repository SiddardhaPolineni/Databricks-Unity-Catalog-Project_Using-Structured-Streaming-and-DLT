...
class SetupHelper():
    def __init__(self,env):
        ...
        self.checkpoint_base = Conf.base_dir_checkpoint + "/checkpoint"
        self.catalog = env
    ...
    def create_registered_users_bz(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.registered_users_bz", end='')
        ...
        """)
            ...
            raise ReferenceError(f"database {self.catalog}.{self.db_name} not created. Cannot create table in default database")
    
    def create_gym_logins_bz(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.gym_logins_bz", end='')
    ...
    def create_kafka_multiplex_bz(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.kafka_multiplex_bz", end='')
    ...
    def create_users(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.users", end='')
            spark.sql(f"""CREATE TABLE IF NOT EXISTS {self.catalog}.{self.db_name}.users(
                user_id bigint,
                device_id bigint,
                mac_address string,
    ...
    def create_gym_logs(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.gym_logs", end='')
    ...
    def create_user_profile(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.user_profile", end='')
    ...
    def create_heart_rate(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.heart_rate", end='')
    ...
    def create_user_bins(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.user_bins", end='')
    ...
    def create_workouts(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.workouts", end='')
    ...
    def create_completed_workouts(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.completed_workouts", end='')
    ...
    def create_workout_bpm(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.workout_bpm", end='')
    ...
    def create_date_lookup(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.date_lookup", end='')
    ...
    def create_workout_bpm_summary(self):
        if(self.initialized):
            print(f"creating a table {self.catalog}.{self.db_name}.workout_bpm_summary", end='')
